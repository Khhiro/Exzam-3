    ...
    <div className="p-10 bg-[#131517]">
      <div className="flex flex-wrap gap-6 justify-between ">
        <div className="w-full md:w-[56%]">
          <h1 className="text-4xl md:text-[55px] text-[#F7FAFF]">
            Join Us Today! <span className="text-[#CFD3DA]">And Build Your Best Career</span>
          </h1>
          <p className="font-mono text-gray-300 mt-4">
...
<img
      ...
      <div className="mt-[100px]">
        ...
        <div className="flex flex-wrap justify-center gap-5 pt-20">
          {['Legal', 'Legal', 'Legal'].map((role, index) => (
            <div key={index} className="w-full sm:w-[270px] text-center text-gray-300 border border-gray-400 p-2 mt-5">
              {role} (10)
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-6 mt-8">
          {Array(6).fill().map((_, index) => (
            <div key={index} className="flex items-center gap-6 justify-center p-3 w-full sm:w-[80%] lg:w-[80%] border border-gray-400 h-[80px] mt-4">
        ...
        <div className="flex justify-center items-center mt-6">
          <button className="text-white bg-blue-500 p-3 w-[200px] text-center mb-6">
            Load More
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-wrap justify-between mt-10 lg:m-auto">
        {Array(6).fill().map((_, index) => (
          <div key={index} className="w-full sm:w-[530px] p-3 border border-gray-400 mt-5">

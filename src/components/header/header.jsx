...
export default function Header() {
  return (
    <div className="flex items-center text-[20px] text-white justify-between md:ml-10 md:mr-10 mt-10 mb-10 max-w-[1500px]">
      <div>
      ...
      <div className=" md:w-[13%] w-[35%] flex justify-between items-center">
